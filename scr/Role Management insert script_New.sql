BEGIN
 ...
 INSERT INTO [dbo].[TS_Modules] (modulename, moduledescription, moduleuniqueidentifier, availablerights, dataoractionmodule)
  ...
  INSERT INTO [dbo].[TS_Teams] (teamname, teamdescription, createddate, createdby, changeddate, changedby)
    VALUES ('PCAL_Maker_Equity_ASL', 'PCAL_Authorizer_Inv_ASL', GETDATE(), 'ifc\vhassan', GETDATE(), 'ifc\vhassan')
  INSERT INTO [dbo].[TS_Teams] (teamname, teamdescription, createddate, createdby, changeddate, changedby)
    VALUES ('PCAL_Checker_Equity_ASL', 'PCAL_Processor_Inv_ASL', GETDATE(), 'ifc\vhassan', GETDATE(), 'ifc\vhassan')
  INSERT INTO [dbo].[TS_Teams] (teamname, teamdescription, createddate, createdby, changeddate, changedby)
...
INSERT INTO [dbo].[TS_Teams] (teamname, teamdescription, createddate, createdby, changeddate, changedby)
  ...
  FROM dbo.TS_Teams
  WHERE teamname = 'PCAL_Maker_Equity_ASL'
  SELECT
    @l_ts_entitle_teamid3 = teamid
  FROM dbo.TS_Teams
  WHERE teamname = 'PCAL_Checker_Equity_ASL'
  SELECT
